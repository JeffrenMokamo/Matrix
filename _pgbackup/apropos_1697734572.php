                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <h4 class="fw-bold fs-1">Vision</h4>
                            ...
                            <h4 class="fw-bold fs-1">Sur <?= $APP_NAME?></h4>
                            ...
                            <h4 class="fw-bold fs-1">Breafing</h4>
                            ...
                            <button class="btn btn-warning btn-md">
                                <a href="team.php" style="text-decoration:none;color:white;">Voir l'équipe</a>
                            </button>
                        </div>
                        <div class="col-lg-6">
