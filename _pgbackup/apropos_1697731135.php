    ...
    <body>
        ...
        <main class="main" id="top">
            <nav class="navbar navbar-expand-lg navbar-light sticky-top" data-navbar-on-scroll="data-navbar-on-scroll">
                <div class="container">
                    <a class="navbar-brand craiglogobar" href="index.html"> <h2><img src="assets/img/favicons/logo_site_web.png" height="40" alt="logo"/> </h2> </a>
                    ...
                    <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto">
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="#feature">Accueil</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="#marketing">Contact</a>
                            </li>
                        </ul>
                        <div class="d-flex ms-lg-4">
                            <a class="btn btn-secondary-outline" href="#!" style="display:none;">Sign In</a>
                            <a class="btn btn-warning ms-3" href="#!">Se connecter</a>
                        </div>
                    </div>
                </div>
            </nav>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-6 text-md-start text-center py-6">
                            ...
                            <div class="text-center text-md-start">
                                <a class="btn btn-warning me-3 btn-lg" href="produits.php" role="button">Nos services</a>
                                <a class="btn btn-link text-warning fw-medium" href="produits.php#feature"><span class="fas fa-play me-2"></span>Offres </a>
                            </div>
                        </div>
            ...
            <section class="pt-5 pt-md-9 mb-6" id="feature">
                ...
                <div class="container">
                    ...
                    <div class="text-center">
                        <a class="btn btn-warning" href="commande.php!" role="button">Passer commande</a>
                    </div>
                </div>
                <!-- end of .container-->
            </section>
                    ...
                    <div class="row border-top border-top-secondary pt-7">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 mb-lg-0 order-3 order-md-3 order-lg-2">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-1">
                                    <a class="link-900 text-secondary text-decoration-none" href="#!">About us</a>
                                </li>
                                <li class="mb-1">
                                    <a class="link-900 text-secondary text-decoration-none" href="#!">Blog</a>
                                </li>
                                <li class="mb-1">
                                    <a class="link-900 text-secondary text-decoration-none" href="#!">Contact</a>
                                </li>
                                <li class="mb-1">
                                    <a class="link-900 text-secondary text-decoration-none" href="#!">FAQ</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-3 col-md-6 mb-4 mb-lg-0 order-4 order-md-4 order-lg-3">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-1">
                                    <a class="link-900 text-secondary text-decoration-none" href="#!">Disclaimer</a>
                                </li>
                                <li class="mb-1">
                                    <a class="link-900 text-secondary text-decoration-none" href="#!">Financing</a>
                                </li>
                                <li class="mb-1">
                                    <a class="link-900 text-secondary text-decoration-none" href="#!">Privacy Policy</a>
                                </li>
                                <li class="mb-1">
                                    <a class="link-900 text-secondary text-decoration-none" href="#!">Terms of Service</a>
                                </li>
                            </ul>
                        </div>
