                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 text-md-start text-center py-6">
                            ...
                            <div class="text-center text-md-start"><a class="btn btn-warning me-3 btn-lg" href="#!" role="button">Nos services</a><a class="btn btn-link text-warning fw-medium" href="#!"><span class="fas fa-play me-2"></span>Offres </a>
                            </div>
                        </div>
