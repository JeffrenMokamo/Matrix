    ...
    <body>
        ...
        <main class="main" id="top">
            <nav class="navbar navbar-expand-lg navbar-light sticky-top" data-navbar-on-scroll="data-navbar-on-scroll">
                <div class="container"><a class="navbar-brand craiglogobar" href="index.html"> <h2><img src="assets/img/icons/logo.png" height="31" alt="logo"/> </h2> </a>
                    ...
                    <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" aria-current="page" href="#validation">Produits</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" aria-current="page" href="apropos.php">A propos</a>
                            </li>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 text-md-start text-center py-6">
                            ...
                            <div class="text-center text-md-start"><a class="btn btn-warning me-3 btn-lg" href="#!" role="button">Nos services</a><a class="btn btn-link text-warning fw-medium" href="#!"><span class="fas fa-play me-2"></span>A la une </a>
                            </div>
                        </div>
            ...
            <section class="pt-5 pt-md-9 mb-6" id="feature">
                ...
                <div class="container">
                    ...
                    <div class="text-center"><a class="btn btn-warning" href="#!" role="button">En savoir plus</a>
                    </div>
                </div>
                <!-- end of .container-->
            </section>
...
via une programmation variée</p>
            ...
            <section class="pt-5" id="marketing" style="">
                <div class="container">
                    ...
                    <div class="row">
                        <?php
$req = mysqli_query($cnx, "SLECT * FROM tb_produits");
while($craig = mysqli_fetch_array($req)){
    ...
    <div class=\"col-md-4 mb-4\">
                            <div class=\"card\">
                                <img class=\"card-img-top\" src=\"craig[Img] \" />
                                <div class=\"card-body ps-0\">
                                    <p class=\"text-secondary\">By <a class=\"fw-bold text-decoration-none me-1\" href=\"#\">$craig[Description]</a>|<span class=\"ms-1\">03 March 2019</span></p>
                                    <h3 class=\"fw-bold\">craig[Nom]</h3>
                                </div>
                            </div>
                        </div>
    ...
    ");
            ...
            <section class="pb-2 pb-lg-5">
                    ...
                    <div class="row border-top border-top-secondary pt-7">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 mb-lg-0 order-3 order-md-3 order-lg-2">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-1"><a class="link-900 text-secondary text-decoration-none" href="#!">About us</a>
                                </li>
                                <li class="mb-1"><a class="link-900 text-secondary text-decoration-none" href="#!">Blog</a>
                                </li>
                                <li class="mb-1"><a class="link-900 text-secondary text-decoration-none" href="#!">Contact</a>
                                </li>
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 mb-lg-0 order-4 order-md-4 order-lg-3">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="mb-1"><a class="link-900 text-secondary text-decoration-none" href="#!">Disclaimer</a>
                                </li>
                                <li class="mb-1"><a class="link-900 text-secondary text-decoration-none" href="#!">Financing</a>
                                </li>
                                <li class="mb-1"><a class="link-900 text-secondary text-decoration-none" href="#!">Privacy Policy</a>
                                </li>
                ...
                Avec <?= $APP_NAME?>. vos besoins, nos services</p>
                            <form class="mb-3">
                    ...
                    <div class="container border-top py-3">
                        <div class="row justify-content-between">
                            <div class="col-12 col-md-auto mb-1 mb-md-0">
                                <p class="mb-0">&copy; 2023 <?= $APP_NAME?> Inc </p>
                            </div>
